			            ...
			            <div class="content">
			                <div class="profil">
			                    <div class="wow fadeInUp" data-wow-delay="0.2s">
			                        <div class="person">
			                            <h4>Manuela Stepien</h4>  
			                       
			                            <img src="img/manuela.png" alt="" class="img-responsive">
			                            
			                            <h1> Secretary  <h1> 
			                            <p>stepien_manuela@hotmail.com </p>
			                            <div class="anything">
			                ...
			                <div class="profil">
			                    <div class="wow fadeInUp" data-wow-delay="0.4s">
			                        <div class="person">
			                            ...
			                            <img src="img/Ayse.jpg" alt="" class="img-responsive">
			                ...
			                <div class="profil">
			                    <div class="wow fadeInUp" data-wow-delay="0.5s">
			                        <div class="person">
			                            ...
			                            <img src="img/simona.jpg" alt="" class="img-responsive">
			                            <h1>
			                             Front End Web Developer </h1><p> smirauta@gmx.at
			                            </p>
			                               <div >
			                                <div class="social-network">
			                                <a href="#" data-placement="top" title="Facebook"><i class="fa fa-facebook "></i></a>
			                ...
			                <div class="profil">
			                    <div class="wow fadeInUp" data-wow-delay="0.7s">
			                        <div class="person">
			                            ...
			                            <img src="img/hadasa.jpg" alt="" class="img-responsive">
			                 ...
			                 <div class="profil">
			                    <div class="wow fadeInUp" data-wow-delay="0.6s">
			                        <div class="person">
			                            ...
			                            <img src="img/ying.jpg" alt="" class="img-responsive">
			                            <h1> 
			                            Full Stack Web Developer</h1> 
			                            <p>qying23@gmail.com</p>
			                             <div >
			                                <div class="social-network">
			                                <a href="#" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a>
			                                <a href="#" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a>
			                ...
			                <div class="profil">
			                    <div class="wow fadeInUp" data-wow-delay="0.6s">
			                        <div class="person">
			                            ...
			                            <img src="img/giava.jpg" alt="" class="img-responsive">
			                            <h1>
			                ...
			                while($row = $result->fetch_assoc()) {
			                    echo "
			                        ...
			                        <div class='buttons-coll'>
			  							...
			  							<button class='custom-btn btn-1'><a style='text-decoration: none;' href='login.php'>Log In to see more</a></button>
